...
window.onload = function() {
    ...
    insertDiv('#list-1', '<p>Global Franchise Network: Benefit from our extensive network of franchised partners and agents around the world, ensuring seamless global logistics.</p><ul><li>Expertise: A team of experienced logistics professionals dedicated to providing top-notch service.</li><li>Customer-Centric: Tailored solutions to meet the specific needs of your business.</li><li>Technology-Driven: Leveraging the latest technology to provide efficient and transparent logistics services.</li><li>Sustainability: Commitment to eco-friendly practices and reducing the environmental impact of our operations.</li></ul><p>Contact us today to learn more about how SkyDataSol’s logistics services can help your business thrive. Whether you’re interested in partnering with us as a client or exploring franchising opportunities, we’re here to support your logistics needs.</p>', 'after', 'list2-item-divi');
